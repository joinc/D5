...
В результате выполнения заданий необходимо выполнить действия для модификации приложения:
...
3. В файле конфигурации определить адрес для перенаправления на страницу входа в систему и адрес перенаправления после 
успешного входа.
